...
#Desktop Install
$ExePath = 'C:\Temp\TableauPrep-2023-1-0.exe'
...
$oldPrepRemovals = Get-ChildItem -Recurse -Path "C:\programdata\Package Cache\{b24054df-9bab-409c-a91e-93a62b9cbc6c}" -Include "Tableau-setup-p*$Year*.exe" -Exclude "C:\users\%username%\appdata\Roaming\think-cell"
try{
